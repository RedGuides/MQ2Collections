...
public:
	...
	TEST_METHOD(Constructor)
	{
		...
		Assert::AreEqual(static_cast<size_t>(0), m.Count(), L"Map should have size of zero.");
	}
	...
	TEST_METHOD(MakeMapOfOneElement)
	{
		...
		Assert::AreEqual(static_cast<size_t>(1), m.Count(), L"Map should have a size of 1.");
	}
	...
	TEST_METHOD(MakeMapOfThreeElements)
	{
		...
		Assert::AreEqual(static_cast<size_t>(3), m.Count(), L"Map should have a size of 3.");
	}
	...
	TEST_METHOD(ClearedEmptyMapContainsNoElements)
	{
		...
		Assert::AreEqual(static_cast<size_t>(0), m.Count(), L"Map should have a size of zero.");
	}
	...
	TEST_METHOD(RemovalOfNonExistantElementFails)
	{
		...
		Assert::AreEqual(static_cast<size_t>(1), m.Count(), L"Map should have a size of one.");
	}
